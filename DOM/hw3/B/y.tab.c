...
{
  "$end", "error", "$undefined", "AND", "AND_", "OR", "OR_", "NOT",
  "NOT_", "BOOL", "$accept", "line", "and", "or", "not", "bool", YY_NULLPTR
};
#endif
...
{
       1,    11,     2,    10,     3,     1,     4,     2,    13,     3,
       1,     4,     2,     0,     3,    15,     4,     1,     0,     2,
       0,     3,     0,     4,    12,    14,    16
};
